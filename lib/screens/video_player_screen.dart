import 'package:assignment_project/screens/countdown_page.dart';
...
class PlayVideoScreen extends StatefulWidget {
  String topic;
  int topicIndexNo;
  PlayVideoScreen({this.topic, this.topicIndexNo});
        ...
        child: Container(
          ...
          child: YoutubePlayerBuilder(
            ...
            player: YoutubePlayer(
              ...
              onEnded: (data) {
                //Navigator.push(context, MaterialPageRoute(builder: (context) => HomePage(widget.topic.toString())));
                Navigator.push(context, MaterialPageRoute(builder: (context) => CountDownPage(widget.topic.toString())));
              },
            ),
